<?php if (!defined('THINK_PATH')) exit(); switch($addons_config["editor_type"]): case "1": ?>
	...
	<?php case "2": ?>
		...
		<?php else: ?>
			...
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/ueditor/ueditor.config.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/ueditor/ueditor.all.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/ueditor/lang/zh-cn/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
         
			<script type="text/javascript">
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				window.UEDITOR_HOME_URL = "/weiphp/Public/static/ueditor";
            ...
            <script type="text/javascript" charset="utf-8" src="/weiphp/Public/static/ueditor/h5/main.js?v=<?php echo SITE_VERSION;?>"></script><?php endif; break;?>
	<?php case "3": ?>
